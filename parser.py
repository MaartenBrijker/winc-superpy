...
def my_parser():
    ...
    parser = argparse.ArgumentParser(description='Application supports buying and selling inventory, and returning statistics about inventory, revenue and profit.')
    ...
    # The Inventory parser has 3 optional flags, either now or yesterday and we can add a save statement.
    ...
    inventory.add_argument('--export', action="store_true", help='Export the inventory report to a CSV file')
